...
namespace terra::noise
{
    ...
    public:
        constexpr summed_noise(int64_t seed, size_t octaves, double lunacracity, double persistence);
        constexpr summed_noise(T& noise, size_t octaves, double lunacracity, double persistence);
